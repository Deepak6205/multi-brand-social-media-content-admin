...
export const Header = ({ onMenuToggle }) => {
    ...
    return (
        <header className="h-16 sm:h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 px-4 sm:px-6 md:px-8 flex items-center justify-between sticky top-0 z-30">
            ...
            <div className="flex items-center gap-2 sm:gap-4 flex-1 max-w-sm sm:max-w-xl md:max-w-2xl">
                <div className="relative group w-full">
                    ...
                    <input
                        type="text"
                        placeholder="Search..."
                        className="w-full pl-12 pr-12 py-2 sm:py-3 bg-slate-100 border-transparent focus:bg-white focus:border-brand-primary/20 focus:ring-4 focus:ring-brand-primary/5 rounded-2xl transition-all outline-none text-slate-600 font-medium text-sm"
                    />
